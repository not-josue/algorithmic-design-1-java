...
public class BicycleBuilderTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Bicycle's front wheel: Diameter " + b01.getFrontWheel().getDiameter()
						+ " Width: " + b01.getFrontWheel().getWidth());
		System.out.println(
				"Bicycle's back wheel: Diameter " + b01.getBackWheel().getDiameter()
						+ " Width: " + b01.getBackWheel().getWidth());
		System.out.println("Bicycle's frame: Size: " + b01.getFrame().getSize()
				+ " Type: " + b01.getFrame().getType());
		...
		Bicycle b02 = new Bicycle("Big Wheel", new Wheel(55.0, 2.5),
				new Wheel(18.0, 2.0), new Frame(60.0, "Penny-Farthing"));
		System.out.println(b02);

		System.out.println(
				"\nCreating another bike using the parameterized constructor with invalid values");
		Bicycle b03 = new Bicycle(null, new Wheel(555.0, -2.5),
				new Wheel(-18.0, 22.0), new Frame(-60.0, "dirt"));
		System.out.println(b03);

		// Equals
		System.out.println("\nChecking the \"equals\" method");
		System.out.println(
				"Does the first and third bicycles have different memory addresses? "
						+ (b01 != b03));
		System.out
				.println("Does the first and third bicycles have the same properties? "
						+ b01.equals(b03));
		System.out.println(
