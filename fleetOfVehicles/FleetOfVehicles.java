...
public class FleetOfVehicles {
	...
	// Removes a vehicle. It searches through the array for a vehicle that is
	// equal to
	...
	public static void main(String[] args) {
		...
		FleetOfVehicles fOfV = new FleetOfVehicles();// Creates a new instance of
																									// the FleetOfVehicles to be
																									// used
